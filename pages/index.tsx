...
const Page = styled(motion.div)`
  background-image: url("/struckaxiom.webp");
  ...
  return (
    <Page>
      <Header>
        ...
        >
          Dawid <br /> <PaddedHighlight> Drobny </PaddedHighlight>
        </Name>
        <H2
        ...
        >
          {" "}
          Sleek and modern <br /> web development
        </H2>
      </Header>
      ...
      <br />
      <br />
      <TechnologiesTitle right="right"> My projects </TechnologiesTitle>
      <Projects>
        <Project
          title="Work planner 3000"
          link="https://github.com/vilchyyy/work-planner-3000"
          image="/dashboard.png"
        >
          <IconBrandTypescript height={70} width={50} stroke={1.25} />
          <IconBrandMysql height={70} width={50} stroke={1.25} />
          <IconBrandNextjs height={70} width={50} stroke={1.25} />
          <IconBrandTailwind height={70} width={50} stroke={1.25} />
          <IconBrandPrisma height={70} width={50} stroke={1.25} />
          <IconKey height={70} width={50} stroke={1.25} />
        ...
        >
          ...
          <IconBrandFramer height={70} width={50} stroke={1.25} />
          <IconBrandNextjs height={70} width={50} stroke={1.25} />
        </Project>
        <Project
        ...
        >
          ...
          <IconApi height={70} width={50} stroke={1.25} />
        </Project>
      </Projects>

      <TechnologiesTitle> My timeline </TechnologiesTitle>
      <br />
      <br />
      <br />
      <br />
        ...
        events={[
          {
            ...
            description:
              "Started going to technical school no 4 in Jastrzebie-Zdroj. At the IT profile I learned and am still learning programming and networking.",
            logo: Zs6Logo,
            date: "09/2019",
            imgWidth: "150px",
            imgHeight: "150px",
          },
          {
            ...
            description:
              "I had some background in basic HTML and CSS, but this was the real start for me. From this point I became very commited to learning new stuff.",
            logo: Reactlogo,
            date: "07/2021",
            imgWidth: "100px",
            imgHeight: "100px",
          },
          {
            ...
            description:
              "I was an intern at IT.Focus() company. I was working on a project for a client. I was working on frontend and backend. I was using ReactJS and NestJS.",
            logo: ITFocusLogo,
            date: "05/2022",
            imgWidth: "300px",
            imgHeight: "300px",
          },
          {
            ...
            description:
              "I came back to the company during August where I focused on Frontend. Me and other interns reworked internal tool for planning work.",
            logo: ITFocusLogo,
            date: "08/2022",
            imgWidth: "300px",
            imgHeight: "300px",
